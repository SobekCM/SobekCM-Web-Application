...
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (1, 1, 'Load reports from FDA (Florida Digital Archives) for Florida universities', NULL, 'SobekCM.Builder_Library.Modules.PreProcess.ProcessPendingFdaReportsModule', false, 1, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (2, 2, 'Build the aggregation browse files', NULL, 'SobekCM.Builder_Library.Modules.PostProcess.BuildAggregationBrowsesModule', true, 1, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (3, 3, 'Convert office files to PDFs', NULL, 'SobekCM.Builder_Library.Modules.Items.ConvertOfficeFilesToPdfModule', true, 1, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (4, 3, 'Extract text from all PDFs', NULL, 'SobekCM.Builder_Library.Modules.Items.ExtractTextFromPdfModule', true, 2, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (5, 3, 'Create thumbnails for all PDFs', NULL, 'SobekCM.Builder_Library.Modules.Items.CreatePdfThumbnailModule', true, 3, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (6, 3, 'Extract the text from included HTML files', NULL, 'SobekCM.Builder_Library.Modules.Items.ExtractTextFromHtmlModule', true, 4, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (7, 3, 'Extract the text from included (non-standard) XML files', NULL, 'SobekCM.Builder_Library.Modules.Items.ExtractTextFromXmlModule', true, 5, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (8, 3, 'OCR tiff files', NULL, 'SobekCM.Builder_Library.Modules.Items.OcrTiffsModule', true, 6, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (9, 3, 'Clean any dirty ocr (non-unicode friendly)', NULL, 'SobekCM.Builder_Library.Modules.Items.CleanDirtyOcrModule', false, 7, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (10, 3, 'Check for SSNs in any loaded text', NULL, 'SobekCM.Builder_Library.Modules.Items.CheckForSsnModule', true, 8, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (11, 3, 'Handle extra large JPEGs', NULL, 'SobekCM.Builder_Library.Modules.Items.ConvertLargeJpegsItemModule', true, 9, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (12, 3, 'Create image derivatives (jpegs and jpeg2000s)', NULL, 'SobekCM.Builder_Library.Modules.Items.CreateImageDerivativesModule', true, 10, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (13, 3, 'Copy all incoming files to the archive folder', NULL, 'SobekCM.Builder_Library.Modules.Items.CopyToArchiveFolderModule', true, 11, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (14, 3, 'Move files to the image server', NULL, 'SobekCM.Builder_Library.Modules.Items.MoveFilesToImageServerModule', true, 12, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (15, 3, 'Reload the METS and basic database info', NULL, 'SobekCM.Builder_Library.Modules.Items.ReloadMetsAndBasicDbInfoModule', true, 13, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (16, 3, 'Update JPEG attributes (width and height)', NULL, 'SobekCM.Builder_Library.Modules.Items.UpdateJpegAttributesModule', true, 14, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (17, 3, 'Attach all non-image files to the item', NULL, 'SobekCM.Builder_Library.Modules.Items.AttachAllNonImageFilesModule', true, 15, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (18, 3, 'Add new image files (and associated views) to the item', NULL, 'SobekCM.Builder_Library.Modules.Items.AddNewImagesAndViewsModule', false, 16, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (19, 3, 'Ensure a main thumbnail is referenced', NULL, 'SobekCM.Builder_Library.Modules.Items.EnsureMainThumbnailModule', true, 17, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (20, 3, 'Get number of pages for PDF-only types', NULL, 'SobekCM.Builder_Library.Modules.Items.GetPageCountFromPdfModule', true, 18, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (21, 3, 'Update the web.config for restricted items', NULL, 'SobekCM.Builder_Library.Modules.Items.UpdateWebConfigModule', true, 19, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (22, 3, 'Save the service METS file', NULL, 'SobekCM.Builder_Library.Modules.Items.SaveServiceMetsModule', true, 20, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (23, 3, 'Save a Marc21 XML file', NULL, 'SobekCM.Builder_Library.Modules.Items.SaveMarcXmlModule', true, 21, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (24, 3, 'Save to the database', NULL, 'SobekCM.Builder_Library.Modules.Items.SaveToDatabaseModule', true, 22, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (26, 3, 'Clean the web resource folder', NULL, 'SobekCM.Builder_Library.Modules.Items.CleanWebResourceFolderModule', true, 25, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (27, 3, 'Build statice version for SEO', NULL, 'SobekCM.Builder_Library.Modules.Items.CreateStaticVersionModule', true, 26, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (28, 3, 'Add tracking information', NULL, 'SobekCM.Builder_Library.Modules.Items.AddTrackingWorkflowModule', true, 27, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (29, 4, 'Loads the METS and basic database info', NULL, 'SobekCM.Builder_Library.Modules.Items.ReloadMetsAndBasicDbInfoModule', true, 1, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (30, 4, 'Delete item in database and folder', NULL, 'SobekCM.Builder_Library.Modules.Items.DeleteItemModule', true, 2, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (31, 5, 'Expire old builder logs', NULL, 'SobekCM.Builder_Library.Modules.Schedulable.ExpireOldLogEntriesModule', true, 1, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (32, 6, 'Rebuild all aggregation browse files', NULL, 'SobekCM.Builder_Library.Modules.Schedulable.RebuildAllAggregationBrowsesModule', true, 1, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (33, 7, 'Send new item emails', NULL, 'SobekCM.Builder_Library.Modules.Schedulable.SendNewItemEmailsModule', true, 1, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (34, 8, 'Solr/Lucene index optimization', NULL, 'SobekCM.Builder_Library.Modules.Schedulable.SolrLuceneIndexOptimizationModule', true, 1, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (36, 10, 'Check packages for age and move', NULL, 'SobekCM.Builder_Library.Modules.Folders.MoveAgedPackagesToProcessModule', true, 1, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (37, 10, 'Check for any bib id restrictions on this folder', NULL, 'SobekCM.Builder_Library.Modules.Folders.ApplyBibIdRestrictionModule', true, 2, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (38, 10, 'Validate each folder and classify (delete v. new/update)', NULL, 'SobekCM.Builder_Library.Modules.Folders.ValidateAndClassifyModule', true, 3, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (39, 3, 'Attach ALL the images in the resource folder to the item', NULL, 'SobekCM.Builder_Library.Modules.Items.AttachImagesAllModule', true, 15, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (40, 11, 'Usage statistics calculation and usage email sends', NULL, 'SobekCM.Builder_Library.Modules.Schedulable.CalculateUsageStatisticsModule', true, 1, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (41, 3, 'Save to the new version 5 beta solr/lucene indexes.', NULL, 'SobekCM.Builder_Library.Modules.Items.SaveToSolrLuceneModule_v5', true, 24, NULL, NULL, NULL);
...
insert into SobekCM_Settings (Setting_Key, Setting_Value, TabPage, Heading, Hidden, Reserved, Help, Options, SettingID, Dimensions) values ('PostArchive Files To Delete', '(.*?)\.(tif)', 'Builder', 'Archive Settings', false, 0, 'Regular expression indicates which files should be deleted AFTER being archived by the builder/bulk loader.\n\nExample: ''(.*?)\\.(tif)''', NULL, 34, NULL);
insert into SobekCM_Settings (Setting_Key, Setting_Value, TabPage, Heading, Hidden, Reserved, Help, Options, SettingID, Dimensions) values ('PreArchive Files To Delete', '(.*?)\.(QC.jpg)', 'Builder', 'Archive Settings', false, 0, 'Regular expression indicates which files should be deleted BEFORE being archived by the builder/bulk loader.\n\nExample: ''(.*?)\\.(QC.jpg)''', NULL, 35, NULL);
...
insert into SobekCM_Settings (Setting_Key, Setting_Value, TabPage, Heading, Hidden, Reserved, Help, Options, SettingID, Dimensions) values ('Search System', 'OpenSobek', 'System / Server Settings', 'Search Preferences', false, 0, 'Which system and schema to use for searching', 'OpenSobek', 79, NULL);
