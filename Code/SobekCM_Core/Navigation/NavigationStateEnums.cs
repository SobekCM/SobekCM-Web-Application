namespace SobekCM.Core.Navigation
{
    ...
    // Admin_Type_Enum removed (Phase F, 2026-08-24) - admin view type is now a plugin-extensible string,
    // see Admin_View_Codes for the built-in codes and AdminViewer_Factory for how a code resolves to a viewer.
