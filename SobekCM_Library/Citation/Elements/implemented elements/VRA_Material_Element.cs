...
{
    /// <summary> Element allows entry of the VRACore material field </summary>
    /// <remarks> This class extends the <see cref="TextBox_TextBox_Element"/> class. </remarks>
    public class VRA_Material_Element : TextBox_TextBox_Element
    {
        /// <summary> Constructor for a new instance of the VRA_Material_Element class </summary>
        public VRA_Material_Element() : base("Materials:", "vra_materials")
        {
            SecondLabel = "Element described";
            Repeatable = true;
        }
        ...
        /// <param name="Current_User"> Current user, who's rights may impact the way an element is rendered </param>
        /// <remarks> This clears any preexisting material information </remarks>
