...
namespace SobekCM.Library.AggregationViewer.Viewers
{
    ...
    public class dLOC_Search_AggregationViewer : abstractAggregationViewer
    {
        ...
        public dLOC_Search_AggregationViewer(RequestCache RequestSpecificValues, AggregationViewBag ViewBag, HttpContext Context)
        ...
        {
            Tracer?.Add_Trace("dLOC_Search_AggregationViewer.Write_Main_HTML", "Adding simple search tips");
