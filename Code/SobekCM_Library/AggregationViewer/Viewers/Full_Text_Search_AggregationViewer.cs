...
namespace SobekCM.Library.AggregationViewer.Viewers
{
    ...
    public class Full_Text_Search_AggregationViewer : abstractAggregationViewer
    {
        ...
        public Full_Text_Search_AggregationViewer(RequestCache RequestSpecificValues, AggregationViewBag ViewBag, HttpContext Context)
        ...
        public override void Write_Search_Box_HTML(TextWriter Output, Custom_Tracer Tracer)
        {
            ...
            Output.WriteLine("    <button id=\"sbkFtsav_SearchButton\" class=\"sbk_GoButton\" title=\"" + search_collection + "\" onclick=\"" + Search_Script_Action + ";return false;\">" + Localization_Gateway.Aggregation_Common.Go(language) + "</button>");
