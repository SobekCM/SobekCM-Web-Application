...
namespace SobekCM.Library.Citation.Elements
{
    ...
    public abstract class TextArea_Element : abstract_Element
    {
        ...
        protected void render_helper(TextWriter Output, List<string> InstanceValues, string Skin_Code, bool IsMozilla, User_Object Current_User, string CurrentLanguage, Language_Support_Info Translator, string Base_URL)
        {
        ...
        /// <param name="Translator"> Language support object which handles simple translational duties </param>
        /// <param name="Base_URL"> Base URL for the current request </param>
        protected void render_helper(TextWriter Output, string InstanceValue, string Skin_Code, bool IsMozilla, User_Object Current_User, string CurrentLanguage, Language_Support_Info Translator, string Base_URL)
        {
            string id_name = html_element_name.Replace("_", "");
