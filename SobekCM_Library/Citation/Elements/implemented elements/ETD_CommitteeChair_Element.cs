...
namespace SobekCM.Library.Citation.Elements
{
	...
	public class ETD_CommitteeChair_Element : SimpleTextBox_Element
	{
		/// <summary> Constructor for a new instance of the ETD_CommitteeChair class </summary>
		public ETD_CommitteeChair_Element()
			: base("Committee Chair", "etd_committeechair")
		{
			Repeatable = false;
		}
