...
(N'Search System',N'Solr 7',N'System / Server Settings',N'Search Preferences',0,0,N'Which system and schema to use for searching - "Solr 7" uses the legacy Solr field names (safe for Solr 7 and older); "Solr 9+" uses the updated docValues-backed sort/group field names, which requires the current schema.xml and a full reindex.',N'Solr 7|Solr 9+',79,NULL),
