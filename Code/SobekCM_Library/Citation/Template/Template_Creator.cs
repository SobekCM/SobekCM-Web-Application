...
namespace SobekCM.Library.Citation.Template
{
    ...
    public class Template_Creator
    {
        ...
        public static void Create(string directory)
        {
            ...
            writer.WriteLine("			<name language=\"fre\">Informations G�n�rales</name>");
            ...
            writer.WriteLine("				<name language=\"spa\">Informaci�n Titular</name>");
            ...
            writer.WriteLine("				<name language=\"fre\">Autorit�s du Nom</name>");
            ...
            writer.WriteLine("			<name language=\"fre\">Sujets et Mots-Cl�s</name>");
            ...
            writer.WriteLine("				<name language=\"fre\">Ic�nes pour l'Internet</name>");
            ...
            writer.WriteLine("				<name language=\"fre\">P�riodique</name>");
            writer.WriteLine("			<panel>");
            writer.WriteLine("				<name language=\"eng\">Serial Hierarchy</name>");
            writer.WriteLine("				<name language=\"spa\">Jerarqu�a Serial</name>");
            writer.WriteLine("				<name language=\"fre\">Hi�rarchie P�riodique</name>");
            ...
            writer.WriteLine("				<name language=\"fre\">Table des Mati�res</name>");
            writer.WriteLine("			<panel>");
