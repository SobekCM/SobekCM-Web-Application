...
namespace SobekCM.Library.Citation.Elements
{
    ...
    public abstract class ComboBox_TextBox_Element : abstract_Element
    {
        ...
        protected void render_helper(TextWriter Output, string SelectValue, string TextValue, string Skin_Code, User_Object Current_User, string CurrentLanguage, Language_Support_Info Translator, string Base_URL)
        {
        ...
        protected void render_helper(TextWriter Output, string SelectValue, string TextValue, string Skin_Code, User_Object Current_User, string CurrentLanguage, Language_Support_Info Translator, string Base_URL, bool InitialValue)
        {
        ...
        /// <param name="Translator"> Language support object which handles simple translational duties </param>
        /// <param name="Base_URL"> Base URL for the current request </param>
        protected void render_helper(TextWriter Output, List<string> SelectValues, List<string> TextValues, string Skin_Code, User_Object Current_User, string CurrentLanguage, Language_Support_Info Translator, string Base_URL)
        {
            ...
            if (Repeatable)
            {
                Output.WriteLine("          <a title=\"" + Translator.Get_Translation("Click to add another", CurrentLanguage) + " " + Translator.Get_Translation(Title, CurrentLanguage).ToLower() + ".\" href=\"" + Base_URL + "l/technical/javascriptrequired\" onmousedown=\"return " + html_element_name + "_add_new_item();\"><img class=\"repeat_button\" src=\"" + REPEAT_BUTTON_URL + "\" /></a>");
            }
        ...
        /// <param name="Base_URL"> Base URL for the current request </param>
        /// <param name="InitialValue"> Flag indicates if the value in the select_value param is actually instructional text, and not a true value</param>
        protected void render_helper(TextWriter Output, string SelectValue, List<string> UserdefinedPossible, string TextValue, string Skin_Code, User_Object Current_User, string CurrentLanguage, Language_Support_Info Translator, string Base_URL, bool InitialValue)
        {
            string id_name = html_element_name.Replace("_", "");
