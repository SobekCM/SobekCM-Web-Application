...
namespace SobekCM.Library.HTML
{
    ...
    public class Aggregation_HtmlSubwriter : abstractHtmlSubwriter
    {
        ...
        public override void Write_Within_HTML_Head(TextWriter Output, Custom_Tracer Tracer)
        {
            ...
            {
                Output.WriteLine("  <link rel=\"search\" href=\"" + RequestSpecificValues.Current_Mode.Base_URL + "default/opensearch.xml\" type=\"application/opensearchdescription+xml\"  title=\"Add " + RequestSpecificValues.Current_Mode.Portal_Abbreviation + " Search\" />");
            ...
            if ((!behaviors.Contains(HtmlSubwriter_Behaviors_Enum.Suppress_SearchForm)) && ((collectionViewer == null) || (!collectionViewer.Is_Internal_View)))
            {
                ...
                if ((RequestSpecificValues.Current_Mode.Mode == Display_Mode_Enum.Aggregation) && ((RequestSpecificValues.Current_Mode.Aggregation_Type == Aggregation_Type_Enum.Home) || (RequestSpecificValues.Current_Mode.Aggregation_Type == Aggregation_Type_Enum.Home_Edit)))
                {
                    ...
                    if ((RequestSpecificValues.Current_User != null) && (RequestSpecificValues.Current_User.LoggedOn))
                    {
                        ...
                        Output.WriteLine("  <div class=\"sbk_PopupTitle\"><table style=\"width:100%\"><tr><td style=\"text-align:left\">" + Localization_Gateway.Aggregation_Sharing.Email_Popup_Title(RequestSpecificValues.Current_Mode.Language) + "</td><td style=\"text-align:right\"> <a href=\"#template\" alt=\"" + Localization_Gateway.Aggregation_Sharing.Email_Popup_Close_Alt(RequestSpecificValues.Current_Mode.Language) + "\" onclick=\"email_form_close()\">X</a> &nbsp; </td></tr></table></div>");
                        Output.WriteLine("  <br />");
                        Output.WriteLine("  <fieldset><legend>" + Localization_Gateway.Aggregation_Sharing.Email_Info_Prompt(RequestSpecificValues.Current_Mode.Language) + " &nbsp; </legend>");
                        Output.WriteLine("    <br />");
                        Output.WriteLine("    <table class=\"sbk_PopupTable\">");

                        // Add email address line
                        Output.Write("      <tr><td style=\"width:80px\"><label for=\"email_address\">" + Localization_Gateway.Aggregation_Sharing.To_Label(RequestSpecificValues.Current_Mode.Language) + "</label></td>");
                        ...
                        // Add comments area
                        Output.Write("      <tr style=\"vertical-align:top\"><td><br /><label for=\"email_comments\">" + Localization_Gateway.Aggregation_Sharing.Comments_Label(RequestSpecificValues.Current_Mode.Language) + "</label></td>");
                        ...
                        // Add format area
                        Output.Write("      <tr style=\"vertical-align:top\"><td>" + Localization_Gateway.Aggregation_Sharing.Format_Label(RequestSpecificValues.Current_Mode.Language) + "</td>");
                        Output.Write("<td><input type=\"radio\" name=\"email_format\" id=\"email_format_html\" value=\"html\" checked=\"checked\" /> <label for=\"email_format_html\">" + Localization_Gateway.Aggregation_Sharing.Html_Label(RequestSpecificValues.Current_Mode.Language) + "</label> &nbsp; &nbsp; ");
                        Output.WriteLine("<input type=\"radio\" name=\"email_format\" id=\"email_format_text\" value=\"text\" /> <label for=\"email_format_text\">" + Localization_Gateway.Aggregation_Sharing.Plain_Text_Label(RequestSpecificValues.Current_Mode.Language) + "</label></td></tr>");

                        Output.WriteLine("    </table>");
                        Output.WriteLine("    <br />");
                        Output.WriteLine("  </fieldset><br />");
                        Output.WriteLine("  <div style=\"text-align:center; font-size:1.3em;\">");
                        Output.WriteLine("    <button title=\"Send\" class=\"roundbutton\" onclick=\"return email_form_close();\"> " + Localization_Gateway.Aggregation_Sharing.Cancel_Button(RequestSpecificValues.Current_Mode.Language) + " </button> &nbsp; &nbsp; ");
                        Output.WriteLine("    <button title=\"Send\" class=\"roundbutton\" type=\"submit\"> " + Localization_Gateway.Aggregation_Sharing.Send_Button(RequestSpecificValues.Current_Mode.Language) + " </button>");
        ...
        private void Add_Sharing_Buttons(TextWriter Output, string FormName, string Style)
        {
            ...
            if ((RequestSpecificValues.Current_Mode.Home_Type == Home_Type_Enum.Personalized) && (RequestSpecificValues.Current_Mode.Aggregation.Length == 0))
            {
                Output.Write("<img class=\"ResultSavePrintButtons\" border=\"0px\" name=\"share_button\" id=\"share_button\" src=\"" + RequestSpecificValues.Current_Mode.Base_URL + "design/skins/" + RequestSpecificValues.HTML_Skin.Base_Skin_Code + "/buttons/share_rect_button.gif\" title=\"" + Localization_Gateway.Aggregation_Sharing.Share_Title(RequestSpecificValues.Current_Mode.Language) + "\" />");
            }
            else
            {
        ...
        protected internal bool add_home_html(TextWriter Output, Custom_Tracer Tracer)
        {
            ...
            else
            {
                ...
                if (RequestSpecificValues.Current_Mode.Home_Type != Home_Type_Enum.Personalized)
                {
                    ...
                    {
                        string listText = Localization_Gateway.Aggregation_Home.List_View(RequestSpecificValues.Current_Mode.Language);
                        string descriptionText = Localization_Gateway.Aggregation_Home.Brief_View(RequestSpecificValues.Current_Mode.Language);
                        string treeText = Localization_Gateway.Aggregation_Home.Tree_View(RequestSpecificValues.Current_Mode.Language);
                        string THUMBNAIL_TEXT = Localization_Gateway.Aggregation_Home.Thumbnail_View(RequestSpecificValues.Current_Mode.Language);
        ...
        protected internal void write_personalized_home(TextWriter Output, Custom_Tracer Tracer)
        {
            ...
            // Write this theme
            Output.WriteLine("<br />");
            Output.WriteLine("<p>Welcome to your personalized " + RequestSpecificValues.Current_Mode.Portal_Abbreviation + " home page.  This page displays any collections you have added, as well as any of your bookshelves you have made public.</p>");
            ...
            Output.WriteLine("    <td class=\"sbkAghsw_CollectionButton\">" + Environment.NewLine + "      <span class=\"sbkAghsw_CollectionButtonImg\"><a href=\"" + UrlWriterHelper.Redirect_URL(RequestSpecificValues.Current_Mode) + "\"><img src=\"" + Static_Resources_Gateway.Home_Button_Gif + "\" alt=\"Go to my" + RequestSpecificValues.Current_Mode.Portal_Abbreviation + " home\" /></a></span>" + Environment.NewLine + "      <span class=\"sbkAghsw_CollectionButtonTxt\"><a href=\"" + UrlWriterHelper.Redirect_URL(RequestSpecificValues.Current_Mode) + "\">my" + RequestSpecificValues.Current_Mode.Portal_Abbreviation + " Home</a></span>" + Environment.NewLine + "    </td>");
