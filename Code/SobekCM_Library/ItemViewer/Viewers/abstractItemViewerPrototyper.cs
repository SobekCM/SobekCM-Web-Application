...
namespace SobekCM.Library.ItemViewer.Viewers
{
    public abstract class abstractItemViewerPrototyper : iItemViewerPrototyper
    {
        ...
        public virtual bool Has_Access(BriefItemInfo CurrentItem, User_Object CurrentUser, Navigation_Object CurrentRequest, HttpContext Context)
        {
        ...
        /// <param name="Context"> Current HTTP context </param>
        public virtual void Add_Menu_Items(BriefItemInfo CurrentItem, User_Object CurrentUser, Navigation_Object CurrentRequest, List<Item_MenuItem> MenuItems, HttpContext Context)
        {
        ...
        public virtual iItemViewer Create_Viewer(BriefItemInfo CurrentItem, User_Object CurrentUser, Navigation_Object CurrentRequest, Custom_Tracer Tracer, HttpContext Context)
        {
