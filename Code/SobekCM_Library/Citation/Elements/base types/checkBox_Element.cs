...
namespace SobekCM.Library.Citation.Elements
{
    ...
    public abstract class CheckBox_Element : abstract_Element
    {
        ...
        protected void render_helper(TextWriter Output, bool InstanceValue, string Skin_Code, User_Object Current_User, string CurrentLanguage, Language_Support_Info Translator, string Base_URL)
        {
