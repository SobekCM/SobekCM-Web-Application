...
namespace SobekCM.Library.MySobekViewer
{
    ...
    public class Group_Add_Volume_MySobekViewer : abstract_MySobekViewer
    {
        ...
        public Group_Add_Volume_MySobekViewer(RequestCache RequestSpecificValues, HttpContext Context) : base(RequestSpecificValues, Context)
        {
            ...
            string hidden_request = Context.Request.HasFormContentType ? (Context.Request.Form["action"].TrimFirst() ?? String.Empty) : String.Empty;
        ...
        {
            Tracer.Add_Trace("Group_Add_Volume_MySobekViewer.Write_HTML");
