...
namespace SobekCM.Library.Citation.Elements
{
	...
	public class LCCN_Element : SimpleTextBox_Element
	{
		...
		public override void Render_Template_HTML(TextWriter Output, SobekCM_Item Bib, string Skin_Code, bool IsMozilla, StringBuilder PopupFormBuilder, User_Object Current_User, Web_Language_Enum CurrentLanguage, Language_Support_Info Translator, string Base_URL)
		{
			...
			if (Acronym.Length == 0)
			{
				const string defaultAcronym = "Library of Congress Control Number (LCCN)";
			...
			const string identifierType = "LCCN";
		...
		public override void Save_To_Bib(SobekCM_Item Bib)
		{
			...
			foreach (string newNumber in from thisKey in getKeys where thisKey.IndexOf(html_element_name.Replace("_", "")) == 0 select Context.Request.Form[thisKey])
			{
				Bib.Bib_Info.Add_Identifier(newNumber, "LCCN");
				return;
			}
		}
	}
