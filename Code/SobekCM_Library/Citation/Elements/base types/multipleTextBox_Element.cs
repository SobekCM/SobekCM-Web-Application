...
namespace SobekCM.Library.Citation.Elements
{
    ...
    public abstract class MultipleTextBox_Element : abstract_Element
    {
        ...
        protected void render_helper(TextWriter Output, IList<string> InstanceValues, string Skin_Code, User_Object Current_User, string CurrentLanguage, Language_Support_Info Translator, string Base_URL)
        {
        ...
        protected void render_helper(TextWriter Output, string InstanceValue, string Skin_Code, User_Object Current_User, string CurrentLanguage, Language_Support_Info Translator, string Base_URL)
        {
            ...
            else
            {
                ...
                if (Repeatable)
                {
                    Output.WriteLine("          <span id=\"" + html_element_name + "_repeaticon\" name=\"" + html_element_name + "_repeaticon\"><img title=\"" + Translator.Get_Translation("Click to add another", CurrentLanguage) + " " + Translator.Get_Translation(Title, CurrentLanguage).ToLower() + ".\" alt=\"+\" border=\"0px\" class=\"repeat_button\" src=\"" + REPEAT_BUTTON_URL + "\" onmousedown=\"add_new_multi_element('" + html_element_name + "', 1," + MaxBoxes + "," + BoxesPerLine + "); return false;\" /></span>");
                }
