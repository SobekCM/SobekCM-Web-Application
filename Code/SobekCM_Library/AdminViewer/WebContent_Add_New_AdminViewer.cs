...
namespace SobekCM.Library.AdminViewer
{
    ...
    public class WebContent_Add_New_AdminViewer : abstract_AdminViewer
    {
                        ...
                        if (RequestSpecificValues.HasNonEmptyQueryString("l3"))
                        {
                            ...
                            if (RequestSpecificValues.HasNonEmptyQueryString("l4"))
                            {
                                ...
                                if (RequestSpecificValues.HasNonEmptyQueryString("l5"))
                                {
                                    ...
                                    if (RequestSpecificValues.HasNonEmptyQueryString("l6"))
                                    {
                                        level6 = RequestSpecificValues.QueryString["l6"];
                                        if (RequestSpecificValues.HasNonEmptyQueryString("l7"))
                                        {
                                            level7 = RequestSpecificValues.QueryString["l7"];
                                            if (RequestSpecificValues.HasNonEmptyQueryString("l8"))
                                            {
        ...
        public override void Write_HTML(TextWriter Output, Custom_Tracer Tracer)
        {
            ...
            Output.WriteLine("    <button title=\"Do not apply changes\" class=\"sbkAdm_RoundButton\" onclick=\"window.location.href='" + cancel_url + "';return false;\"><img src=\"" + Static_Resources_Gateway.Button_Previous_Arrow_Png + "\" class=\"sbkAdm_RoundButton_LeftImg\" alt=\"\" /> " + Localization_Gateway.Buttons.Cancel(RequestSpecificValues.Current_Mode.Language) + "</button> &nbsp; &nbsp; ");
            Output.WriteLine("    <button title=\"Save changes to this user group\" class=\"sbkAdm_RoundButton\" onclick=\"return save_webcontent_edits('false');return false;\">" + Localization_Gateway.Buttons.Save(RequestSpecificValues.Current_Mode.Language) + " <img src=\"" + Static_Resources_Gateway.Button_Next_Arrow_Png + "\" class=\"sbkAdm_RoundButton_RightImg\" alt=\"\" /></button>");
            Output.WriteLine("  </div>");
            Output.WriteLine();
            ...
            Output.WriteLine("        <td><img class=\"sbkSaav_HelpButton\" src=\"" + Static_Resources_Gateway.Help_Button_Jpg + "\" onclick=\"alert('" + INHERIT_HELP + "');\"  title=\"" + INHERIT_HELP + "\" /></td></tr></table>");
            Output.WriteLine("     </td>");
            Output.WriteLine("  </tr>");
