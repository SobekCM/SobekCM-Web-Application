...
namespace SobekCM.Library.ItemViewer.Viewers
{
    ...
    public class Citation_MARC_ItemViewer_Prototyper : iItemViewerPrototyper
    {
        ...
        public virtual void Add_Menu_Items(BriefItemInfo CurrentItem, RequestCache RequestSpecificValues, List<Item_MenuItem> MenuItems)
        {
            ...
            var menuItem = new Item_MenuItem(Localization_Gateway.Item_Menu.Description(CurrentRequest.Language), Localization_Gateway.Citation_Common.Menu_Marc_View(CurrentRequest.Language), null, url, ViewerCode);
    ...
    public class Citation_MARC_ItemViewer : abstractNoPaginationItemViewer
    {
        ...
        public string MARC_String(string Width, Custom_Tracer Tracer)
        {
            ...
            if ((userCanEdit) && (BriefItem.Type != "BIBLEVEL"))
            {
                ...
                builder.AppendLine("<blockquote><button onclick=\"window.location.href='" + UrlWriterHelper.Redirect_URL(CurrentRequest) + "';return false;\" id=\"sbkCiv_MarcEditButton\" class=\"roundbutton\"> " + Localization_Gateway.Buttons.Edit_This_Item(CurrentRequest.Language) + " </button></blockquote>");
            ...
            builder.AppendLine("<br />");
            builder.AppendLine("<br />");
            builder.AppendLine("<div id=\"sbkCiv_MarcAutoGenerated\">" + Localization_Gateway.Citation_MARC.Auto_Generated_Notice(CurrentRequest.Language) + "</div>");
            builder.AppendLine();
            builder.AppendLine("<br />");
            builder.AppendLine("<br />");
