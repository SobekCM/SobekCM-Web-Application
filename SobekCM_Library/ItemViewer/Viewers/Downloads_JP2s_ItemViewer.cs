...
{
    /// <summary> Downloads viewer prototyper, which is used to check to see if there are downloads or JP2s to display, 
    /// to create the link in the main menu, and to create the viewer itself if the user selects that option </summary>
    public class Downloads_JP2s_ItemViewer_Prototyper : iItemViewerPrototyper
    {
        /// <summary> Constructor for a new instance of the Downloads_JP2s_ItemViewer_Prototyper class </summary>
        public Downloads_JP2s_ItemViewer_Prototyper()
        {
            ViewerType = "DOWNLOADS_JP2s";
            ViewerCode = "downloads2";
        }
        ...
        {
            return new Downloads_JP2s_ItemViewer(CurrentItem, CurrentUser, CurrentRequest);
        }
    }


    /// <summary> Item viewer displays all downloads ( i.e., not the page images ) for download and 
    /// also make all of the online JPEG2000s downloadable. </summary>
    /// <remarks> This class extends the abstract class <see cref="abstractNoPaginationItemViewer"/> and implements the 
    /// <see cref="iItemViewer" /> interface. </remarks>
    public class Downloads_JP2s_ItemViewer : abstractNoPaginationItemViewer
    {
        /// <summary> Constructor for a new instance of the Downloads_JP2s_ItemViewer class, used to 
        /// display a list of files to download from a digital resource and also make all of the 
        /// online JPEG2000s downloadable. </summary>
        /// <param name="BriefItem"> Digital resource object </param>
        /// <param name="CurrentUser"> Current user, who may or may not be logged on </param>
        /// <param name="CurrentRequest"> Information about the current request </param>
        public Downloads_JP2s_ItemViewer(BriefItemInfo BriefItem, User_Object CurrentUser, Navigation_Object CurrentRequest)
        {
