...
namespace Census_Metadata_Plugin.ReaderWriter
{
    /// <summary> METS section reader/writer is used to store the census custom metadata
    /// in the METS files for the digital resources </summary>
    public class Census_METS_dmdSec_ReaderWriter : XML_Writing_Base_Type, iPackage_dmdSec_ReaderWriter
    {
