...
namespace SobekCM.Library.ItemViewer.Viewers
{
    ...
    public interface iItemViewerPrototyper
    {
        ...
        bool Has_Access(BriefItemInfo CurrentItem, User_Object CurrentUser, bool IsRestricted);
        ...
        /// <param name="IsRestricted"> Flag indicates if this item is restricted AND the current user is outside the ranges or not in the proper groups</param>
        void Add_Menu_Items(BriefItemInfo CurrentItem, User_Object CurrentUser, Navigation_Object CurrentRequest, List<Item_MenuItem> MenuItems, bool IsRestricted);
        ...
        /// <param name="CurrentUser"> Current user, who may or may not be logged on </param>
        /// <param name="CurrentRequest"> Information about the current request </param>
        /// <param name="CurrentFlags"> Flags about access to this material </param>
        ...
        iItemViewer Create_Viewer(BriefItemInfo CurrentItem, User_Object CurrentUser, Navigation_Object CurrentRequest, Custom_Tracer Tracer, RequestCache_RequestFlags CurrentFlags, HttpContext Context );
    }
}
