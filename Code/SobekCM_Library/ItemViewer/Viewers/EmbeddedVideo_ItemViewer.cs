...
namespace SobekCM.Library.ItemViewer.Viewers
{
    ...
    public class EmbeddedVideo_ItemViewer_Prototyper : iItemViewerPrototyper
    {
        ...
        public virtual void Add_Menu_Items(BriefItemInfo CurrentItem, User_Object CurrentUser, Navigation_Object CurrentRequest, List<Item_MenuItem> MenuItems, bool IsRestricted)
        {
            ...
            string label = Localization_Gateway.EmbeddedVideo.Menu_Video_Label(CurrentRequest.Language);
    ...
    public class EmbeddedVideo_ItemViewer : abstractNoPaginationItemViewer
    {
        ...
        public override void Write_Main_Viewer_Section(TextWriter Output, Custom_Tracer Tracer)
        {
            ...
            Output.WriteLine("          <td><div id=\"sbkEmv_ViewerTitle\">" + Localization_Gateway.EmbeddedVideo.Viewer_Title(CurrentRequest.Language) + "</div></td>");
            Output.WriteLine("        </tr>");
            Output.WriteLine("        <tr>");
