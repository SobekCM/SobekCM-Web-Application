...
namespace SobekCM.Library.ItemViewer.Viewers
{
    ...
    public class Usage_Stats_ItemViewer_Prototyper : iItemViewerPrototyper
    {
        ...
        public virtual void Add_Menu_Items(BriefItemInfo CurrentItem, RequestCache RequestSpecificValues, List<Item_MenuItem> MenuItems)
        {
            ...
            var menuItem = new Item_MenuItem(Localization_Gateway.Item_Menu.Description(CurrentRequest.Language), Localization_Gateway.Citation_Common.Menu_Usage_Statistics(CurrentRequest.Language), null, url, ViewerCode);
