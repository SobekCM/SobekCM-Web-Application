...
namespace SobekCM.Library.AggregationViewer.Viewers
{
    ...
    public class Rotating_Highlight_Search_AggregationViewer : abstractAggregationViewer
    {
        ...
        public Rotating_Highlight_Search_AggregationViewer(RequestCache RequestSpecificValues, AggregationViewBag ViewBag, HttpContext Context)
        ...
        /// <value> This returns the <see cref="Item_Aggregation_Views_Searches_Enum.Rotating_Highlight_Search"/> enumerational value </value>
        public override Item_Aggregation_Views_Searches_Enum Type
        {
            get { return Item_Aggregation_Views_Searches_Enum.Rotating_Highlight_Search; }
        }
        ...
        {
            Tracer?.Add_Trace("Rotating_Highlight_Search_AggregationViewer.Write_Search_Box_HTML", "Adding html for search box");
            ...
            {
                Output.WriteLine("<script type=\"text/javascript\" src=\"" + Static_Resources_Gateway.Contentslider_Js + "\" > </script>");
                Output.WriteLine("<!-- *****************************************");
            ...
            if (frontBannerInfo.Type == Item_Aggregation_Front_Banner_Type_Enum.Left)
            {
                string banner_image = RequestSpecificValues.Current_Mode.Base_URL + "design/" + ViewBag.Hierarchy_Object.ObjDirectory + frontBannerInfo.File.Replace("\\", "/");
            ...
            if ((ViewBag.Hierarchy_Object.Highlights != null) && (ViewBag.Hierarchy_Object.Highlights.Count > 1))
            {
                ...
                foreach (Item_Aggregation_Highlights highlight in ViewBag.Hierarchy_Object.Highlights)
                {
            ...
            else
            {
                if ((ViewBag.Hierarchy_Object.Highlights != null) && (ViewBag.Hierarchy_Object.Highlights.Count > 0))
                {
                    ...
                    if (ViewBag.Hierarchy_Object.Highlights[0].Image.IndexOf("http:") >= 0)
                        ...
                        Output.WriteLine("              <img src=\"" + base_design_location + ViewBag.Hierarchy_Object.Highlights[0].Image + "\" />");
                    Output.WriteLine("            </a>");
                }
            }
            ...
            if (frontBannerInfo.Type == Item_Aggregation_Front_Banner_Type_Enum.Right)
            {
                string banner_image = RequestSpecificValues.Current_Mode.Base_URL + "design/" + ViewBag.Hierarchy_Object.ObjDirectory + frontBannerInfo.File.Replace("\\", "/");
