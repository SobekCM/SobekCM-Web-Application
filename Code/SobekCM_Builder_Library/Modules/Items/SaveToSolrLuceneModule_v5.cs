...
{
    /// <summary> Item-level submission package module saves all of the digital resource information to the new version 5 / beta solr/lucene </summary>
    /// <remarks> This class implements the <see cref="abstractSubmissionPackageModule" /> abstract class and implements the <see cref="iSubmissionPackageModule" /> interface. </remarks>
    public class SaveToSolrLuceneModule_v5 : abstractSubmissionPackageModule
    {
        ...
        public override bool DoWork(Incoming_Digital_Resource Resource, Custom_Tracer Tracer)
        {
            ...
            if (!String.IsNullOrEmpty(Settings.Servers.Document_Solr_Index_URL))
            {
                ...
                {
                    Console.WriteLine("ERROR indexing");
