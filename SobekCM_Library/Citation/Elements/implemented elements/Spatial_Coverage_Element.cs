...
{
    /// <summary> Element allows simple entry of the spatial coverage for an item </summary>
    /// <remarks> This class extends the <see cref="SimpleTextBox_Element"/> class. </remarks>
    public class Spatial_Coverage_Element : SimpleTextBox_Element
    {
        /// <summary> Constructor for a new instance of the Spatial_Coverage_Element class </summary>
        public Spatial_Coverage_Element()
        ...
        public override void Prepare_For_Save(SobekCM_Item Bib, User_Object Current_User)
        {
            if (Bib.Bib_Info.Subjects_Count > 0)
            {
                List<Subject_Info> deletes = Bib.Bib_Info.Subjects.Where(thisSubject => thisSubject.Class_Type == Subject_Info_Type.Hierarchical_Spatial).ToList();
        ...
        public override void Save_To_Bib(SobekCM_Item Bib)
        {
            ...
            foreach (string thisKey in getKeys)
            {
                ...
                {
                    Subject_Info_HierarchicalGeographic hierarchy = Bib.Bib_Info.Add_Hierarchical_Geographic_Subject();
                    hierarchy.ID = "SUBJ662";
                    hierarchy.Area = HttpContext.Current.Request.Form[thisKey];
                }
            }
        }
    }
