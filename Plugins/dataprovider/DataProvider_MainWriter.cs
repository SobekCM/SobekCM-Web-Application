...
namespace SobekCM.Plugins.DataProvider
{
    ...
    /// reflection by <c>MainWriter_Factory</c>, registered through the "dataprovider" extension's
    ...
    public class DataProvider_MainWriter : abstractMainWriter
    {
        ...
        /// <value> This property always returns <see cref="Writer_Codes.Data_Provider"/>. </value>
        public override string Writer_Type { get { return Writer_Codes.Data_Provider; } }
        ...
        private void provide_dataset_items_view_data(TextWriter Output)
        {
            ...
            //Int32.TryParse(RequestSpecificValues.QueryString["iDisplayStart"], out displayStart);
            //Int32.TryParse(RequestSpecificValues.QueryString["iDisplayLength"], out displayLength);

            //// Get the echo value
            //string sEcho = RequestSpecificValues.QueryString["sEcho"];

            //// Get the sorting column and sorting direction
            //Int32.TryParse(RequestSpecificValues.QueryString["iSortCol_0"], out sortingColumn1);
            //if ((RequestSpecificValues.QueryString["sSortDir_0"] != null) && (RequestSpecificValues.QueryString["sSortDir_0"] == "desc"))
            //    sortDirection1 = "desc";
            //Int32.TryParse(RequestSpecificValues.QueryString["iSortCol_1"], out sortingColumn2);
            ...
            //{
            //    if (!String.IsNullOrEmpty(RequestSpecificValues.QueryString[possibility]))
            //    {
            //        field = possibility;
            //        term = RequestSpecificValues.QueryString[possibility];
            //        break;
            //    }
            //}
