...
namespace SobekCM.Engine_Library.Solr.Legacy
{
    ...
    public class Legacy_SolrDocument
    {
        ...
        private readonly List<Legacy_SolrPage> solrpages = new List<Legacy_SolrPage>();
        ...
        /// <summary> Constructor for a new instance of the Legacy_SolrDocument class </summary>
        public Legacy_SolrDocument()
        {
        }
        ...
        public Legacy_SolrDocument(SobekCM_Item Digital_Object, string File_Location)
        {
            ...
            solrpages = new List<Legacy_SolrPage>();
                    ...
                    if (pageNode.Files.Count > 0)
                    {
                        ...
                        if (text_files_existing.ContainsKey(root.ToUpper() + ".TXT"))
                        {
                            try
                            {
                                ...
                                Legacy_SolrPage newPage = new Legacy_SolrPage(digitalObject.BibID, digitalObject.VID, pageorder, pageNode.Label, pageText, thumbnail);
        ...
        public List<Legacy_SolrPage> Solr_Pages
        {
            get { return solrpages; }
        }
        ...
        public string Did
        {
            get { return digitalObject.BibID + ":" + digitalObject.VID; }
        }
        ...
        public string BibID
        {
            get { return digitalObject.BibID; }
        }
        ...
        {
            get { return digitalObject.Behaviors.IP_Restriction_Membership; }
        }
        ...
        public bool Dark
        {
            get { return digitalObject.Behaviors.Dark_Flag; }
        }
        ...
        {
            get { return digitalObject.Bib_Info.Main_Title.Title.ToString().Replace("<i>", " ").Replace("</i>", " "); }
        }
        ...
        public List<string> Titles
        {
            get
            {
                ...
                {
                    foreach (Title_Info thisTitle in digitalObject.Bib_Info.Other_Titles)
                    {
        ...
        {
            get { return digitalObject.Bib_Info.SobekCM_Type_String; }
        }
        ...
        public List<string> Creator
        {
            get
            {
                ...
                {
                    foreach (Name_Info thisName in digitalObject.Bib_Info.Names)
                    {
                        if (thisName.hasData)
                        {
        ...
        public List<string> Publisher
        {
            get
            {
                ...
                {
                    foreach (Publisher_Info thisManufacturer in digitalObject.Bib_Info.Manufacturers)
                    {
        ...
        public List<string> Pubplace
        {
            get
            {
                ...
                {
                    foreach (Origin_Info_Place thisPlace in digitalObject.Bib_Info.Origin_Info.Places)
                    {
                        if ((thisPlace.Place_Text.Length > 0) && (!places.Contains(thisPlace.Place_Text)))
                            places.Add(thisPlace.Place_Text);
                    }
        ...
        public List<string> Targetaudience
        {
            get
            {
                ...
                {
                    foreach (TargetAudience_Info thisAudience in digitalObject.Bib_Info.Target_Audiences)
                    {
        ...
        public List<string> Abstract
        {
            get
            {
                ...
                {
                    foreach (Abstract_Info thisAbstract in digitalObject.Bib_Info.Abstracts)
                    {
        ...
        public List<string> Affiliation
        {
            get
            {
                ...
                {
                    foreach (Affiliation_Info thisAffiliation in digitalObject.Bib_Info.Affiliations)
                    {
        ...
        public List<string> Frequency
        {
            get
            {
                ...
                {
                    foreach (Origin_Info_Frequency thisFrequency in digitalObject.Bib_Info.Origin_Info.Frequencies)
                    {
        ...
        public List<string> MimeType
        {
            get
            {
                ...
                {
                    List<SobekCM_File_Info> allDownloads = digitalObject.Divisions.Download_Tree.All_Files;
        ...
        public string Author_Display
        {
            get
            {
                ...
                if (digitalObject.Bib_Info.Names_Count > 0)
                {
                    foreach (Name_Info thisAuthor in digitalObject.Bib_Info.Names)
                    {
        ...
        {
            get { return digitalObject.Behaviors.Main_Thumbnail; }
        }
        ...
        public string Level1text
        {
            get
            {
                if (digitalObject.Behaviors.Serial_Info.Count > 0)
                {
                    return digitalObject.Behaviors.Serial_Info[0].Display;
                }
                return null;
            }
        }
        ...
        public Nullable<int> Level1index
        {
            get
            {
                if (digitalObject.Behaviors.Serial_Info.Count > 0)
                {
                    return digitalObject.Behaviors.Serial_Info[0].Order;
                }
                return null;
            }
        }
        ...
        public string Level2text
        {
            get
            {
                if (digitalObject.Behaviors.Serial_Info.Count > 1)
                {
                    return digitalObject.Behaviors.Serial_Info[1].Display;
                }
                return null;
            }
        }
        ...
        public Nullable<int> Level2index
        {
            get
            {
                if (digitalObject.Behaviors.Serial_Info.Count > 1)
                {
                    return digitalObject.Behaviors.Serial_Info[1].Order;
                }
                return null;
            }
        }
        ...
        public string Level3text
        {
            get
            {
                if (digitalObject.Behaviors.Serial_Info.Count > 2)
                {
                    return digitalObject.Behaviors.Serial_Info[2].Display;
                }
                return null;
            }
        }
        ...
        public Nullable<int> Level3index
        {
            get
            {
                if (digitalObject.Behaviors.Serial_Info.Count > 2)
                {
                    return digitalObject.Behaviors.Serial_Info[2].Order;
                }
                return null;
            }
        }
        ...
        public string FullText
        {
            get
            {
                ...
                foreach (Legacy_SolrPage thisPage in solrpages)
                {
