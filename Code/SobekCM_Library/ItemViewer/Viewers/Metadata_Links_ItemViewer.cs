...
namespace SobekCM.Library.ItemViewer.Viewers
{
    ...
    public class Metadata_Links_ItemViewer_Prototyper : iItemViewerPrototyper
    {
        ...
        public virtual void Add_Menu_Items(BriefItemInfo CurrentItem, RequestCache RequestSpecificValues, List<Item_MenuItem> MenuItems)
        {
            ...
            var menuItem = new Item_MenuItem(Localization_Gateway.Item_Menu.Description(CurrentRequest.Language), Localization_Gateway.Citation_Common.Menu_Metadata(CurrentRequest.Language), null, url, ViewerCode);
