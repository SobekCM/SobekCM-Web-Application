...
namespace SobekCM.Library.Citation.Elements
{
    ...
    class Zoological_Taxonomy_Form_Element : abstract_Element
    {
        ...
        public override void Render_Template_HTML(TextWriter Output, SobekCM_Item Bib, string Skin_Code, bool IsMozilla, StringBuilder PopupFormBuilder, User_Object Current_User, Web_Language_Enum CurrentLanguage, Language_Support_Info Translator, string Base_URL)
        {
            ...
            PopupFormBuilder.AppendLine("    <tr><td style=\"width:100px;\">Kingdom:</td><td colspan=\"2\"><input class=\"formzootaxon_input sbk_Focusable\" name=\"formzootaxonkingdom_" + zoo_index + "\" id=\"formzootaxonkingdom_" + zoo_index + "\" type=\"text\" value=\"" + System.Net.WebUtility.HtmlEncode(zooInfo.Kingdom) + "\" /></td></tr>");
            PopupFormBuilder.AppendLine("    <tr><td>Phylum:</td><td colspan=\"2\"><input class=\"formzootaxon_input sbk_Focusable\" name=\"formzootaxonphylum_" + zoo_index + "\" id=\"formzootaxonphylum_" + zoo_index + "\" type=\"text\" value=\"" + System.Net.WebUtility.HtmlEncode(zooInfo.Phylum) + "\" /></td></tr>");
            PopupFormBuilder.AppendLine("    <tr><td>Class:</td><td colspan=\"2\"><input class=\"formzootaxon_input sbk_Focusable\" name=\"formzootaxonclass_" + zoo_index + "\" id=\"formzootaxonclass_" + zoo_index + "\" type=\"text\" value=\"" + System.Net.WebUtility.HtmlEncode(zooInfo.Class) + "\" /></td></tr>");
            PopupFormBuilder.AppendLine("    <tr><td>Order:</td><td colspan=\"2\"><input class=\"formzootaxon_input sbk_Focusable\" name=\"formzootaxonorder_" + zoo_index + "\" id=\"formzootaxonorder_" + zoo_index + "\" type=\"text\" value=\"" + System.Net.WebUtility.HtmlEncode(zooInfo.Order) + "\" /></td></tr>");
            PopupFormBuilder.AppendLine("    <tr><td>Family:</td><td colspan=\"2\"><input class=\"formzootaxon_input sbk_Focusable\" name=\"formzootaxonfamily_" + zoo_index + "\" id=\"formzootaxonfamily_" + zoo_index + "\" type=\"text\" value=\"" + System.Net.WebUtility.HtmlEncode(zooInfo.Family) + "\" /></td></tr>");
            PopupFormBuilder.AppendLine("    <tr><td>Genus:</td><td colspan=\"2\"><input class=\"formzootaxon_input sbk_Focusable\" name=\"formzootaxongenus_" + zoo_index + "\" id=\"formzootaxongenus_" + zoo_index + "\" type=\"text\" value=\"" + System.Net.WebUtility.HtmlEncode(zooInfo.Genus) + "\" /></td></tr>");
