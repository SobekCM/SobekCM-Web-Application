...
namespace SobekCM.Library.AdminViewer
{
    ...
    public class WebContent_Mgmt_AdminViewer : abstract_AdminViewer
    {
        ...
        public WebContent_Mgmt_AdminViewer(RequestCache RequestSpecificValues, HttpContext Context) : base(RequestSpecificValues, Context)
        {
        ...
        {
            Tracer.Add_Trace("WebContent_Mgmt_AdminViewer.Write_HTML");

            // Open the item nav form
            Write_ItemNavForm_Opening(Output);

            Output.WriteLine("<!-- WebContent_Mgmt_AdminViewer.Write_HTML -->");
