...
namespace SobekCM.Library.ItemViewer.Viewers
{
    ...
    public class OpenTextbook_Divisions_ItemViewer_Prototyper : abstractItemViewerPrototyper
    {
        ...
        public override void Add_Menu_Items(BriefItemInfo CurrentItem, RequestCache RequestSpecificValues, List<Item_MenuItem> MenuItems)
        {
            ...
            var menuItem = new Item_MenuItem(Localization_Gateway.OpenTextbook_Divisions.Menu_Default_Label(CurrentRequest.Language), null, null, url, ViewerCode);
    ...
    public class OpenTextbook_Divisions_ItemViewer : abstractPageFilesItemViewer
    {
        ...
        public override void Write_Main_Viewer_Section(TextWriter Output, Custom_Tracer Tracer)
        {
            ...
            if (canEdit && !isEditMode)
            {
                ...
                Output.WriteLine("\t\t\t\t\t<a href=\"" + edit_url + "\" title=\"" + Localization_Gateway.OpenTextbook_Common.Edit_Section_Title(CurrentRequest.Language) + "\"><img src=\"" + Static_Resources_Gateway.Edit_Gif + "\" alt=\"\"> " + Localization_Gateway.OpenTextbook_Common.Edit_Content_Link(CurrentRequest.Language) + "</a>");
                Output.WriteLine("\t\t\t\t</div>");
                Output.WriteLine("\t\t\t</div>");
