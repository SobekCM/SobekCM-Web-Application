...
{
    /// <summary> Renders the basic search / home page for a given item aggregation with one search field but also ability to 
    ...
    /// </ul></remarks>
    public class Basic_Search_MimeType_AggregationViewer : abstractAggregationViewer
    {
        ...
        public Basic_Search_MimeType_AggregationViewer(RequestCache RequestSpecificValues, AggregationViewBag ViewBag, HttpContext Context)
        ...
        /// <value> This returns the <see cref="Item_Aggregation_Views_Searches_Enum.Basic_Search_MimeType"/> enumerational value </value>
        public override Item_Aggregation_Views_Searches_Enum Type
        {
            get { return Item_Aggregation_Views_Searches_Enum.Basic_Search_MimeType; }
        }
        ...
        public override void Add_Search_Box_HTML(TextWriter Output, Custom_Tracer Tracer)
        {
            if (Tracer != null)
            {
                Tracer.Add_Trace("Basic_Search_MimeType_AggregationViewer.Add_Search_Box_HTML", "Adding html for search box");
            }
