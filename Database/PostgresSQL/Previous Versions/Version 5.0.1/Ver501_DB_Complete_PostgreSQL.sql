/**
Ver501_DB_Complete_PostgreSQL.sql  - OpenSobek

PostgreSQL equivalent of Ver501_DB_Complete.sql -- Ver5_DB_Complete_PostgreSQL.sql (the
5.0.0 PostgreSQL baseline) with Upgrade_to_Ver501_PostgreSQL.sql's changes folded in
(ClearEngineCacheModule/TesseractOcrModule builder modules, updated OcrTiffsModule
description, version stamp). Builds a complete Version 5.0.1 database from scratch.
Creates the `sobek_builder`/`sobek_user` roles, all tables, views, and
