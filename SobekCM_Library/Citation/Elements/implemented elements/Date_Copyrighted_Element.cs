...
namespace SobekCM.Library.Citation.Elements
{
    ...
    public class Date_Copyrighted_Element : SimpleTextBox_Element
    {
        ...
        /// <param name="Current_User"> Current user, who's rights may impact the way an element is rendered </param>
        /// <remarks> This does nothing since there is only one copyright date  </remarks>
        ...
        public override void Save_To_Bib(SobekCM_Item Bib)
        {
            ...
            foreach (string thisKey in getKeys)
            {
                ...
                {
                    Bib.Bib_Info.Origin_Info.Date_Copyrighted = HttpContext.Current.Request.Form[thisKey];
                    return;
                }
            }
        }
