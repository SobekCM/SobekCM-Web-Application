...
namespace SobekCM.Resource_Object.METS_Sec_ReaderWriters
{
    ...
    public interface iDivision_dmdSec_ReaderWriter
    {
        ...
        bool Write_dmdSec(TextWriter Output_Stream, abstract_TreeNode MetsDivision, Dictionary<string, object> Options);
        ...
        /// <param name="Options"> Dictionary of any options which this METS section writer may utilize</param>
        /// <returns> TRUE if successful, otherwise FALSE</returns>
        bool Read_dmdSec(XmlReader Input_XmlReader, abstract_TreeNode MetsDivision, Dictionary<string, object> Options);
        ...
        bool Include_dmdSec(abstract_TreeNode MetsDivision, Dictionary<string, object> Options);
