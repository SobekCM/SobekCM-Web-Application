...
{
    /// <summary> Writes MODS metadata for the current item being displayed into the HTML head </summary>
    public class MODS_ItemHtmlHeadWriter : iItemHtmlHeadWriter
    {
        /// <summary> Write some MODS metadata about the digital resource into the HTML head </summary>
