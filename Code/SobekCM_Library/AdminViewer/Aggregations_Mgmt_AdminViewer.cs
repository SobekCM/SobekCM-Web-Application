...
namespace SobekCM.Library.AdminViewer
{
    ...
    public class Aggregations_Mgmt_AdminViewer : abstract_AdminViewer
    {
        ...
        /// <value> This always returns the value 'Aggregation Management' </value>
        ...
        {
            get { return Static_Resources_Gateway.Aggregations_Img; }
        }
        ...
        {
            Tracer.Add_Trace("Aggregations_Mgmt_AdminViewer.Write_HTML");
            ...
            Output.WriteLine("<!-- Aggregations_Mgmt_AdminViewer.Write_HTML -->");
        ...
        public override string Container_CssClass { get { return "sbkAsav_ContainerInner"; } }
    }
}
