...
namespace SobekCM.Library.HTML
{
    ...
    public class Web_Content_HtmlSubwriter : abstractHtmlSubwriter
    {
        ...
        public override bool Write_HTML(TextWriter Output, Custom_Tracer Tracer)
        {
            ...
            // ===== Begin original Write_Final_HTML ===== (its own `if (adminMissingScreen) return;` guard is
            // unreachable here since Write_HTML already returned true above in that case; kept for faithfulness)
        ...
        private void write_edit_display(TextWriter Output, Custom_Tracer Tracer)
        {
            ...
            //Output.WriteLine("        <td><input class=\"sbkSbia_HeaderInput sbk_Focusable\" name=\"admin_childpage_title\" id=\"admin_childpage_title\" type=\"text\" value=\"" + System.Net.WebUtility.HtmlEncode(staticWebContent.Title) + "\" /></td>");
            ...
            //Output.WriteLine("        <td><input class=\"sbkSbia_HeaderInput sbk_Focusable\" name=\"admin_childpage_author\" id=\"admin_childpage_author\" type=\"text\" value=\"" + System.Net.WebUtility.HtmlEncode(staticWebContent.Author) + "\" /></td>");
            ...
            //Output.WriteLine("        <td><input class=\"sbkSbia_HeaderInput sbk_Focusable\" name=\"admin_childpage_date\" id=\"admin_childpage_date\" type=\"text\" value=\"" + System.Net.WebUtility.HtmlEncode(staticWebContent.Date) + "\" /></td>");
            ...
            //Output.WriteLine("        <td><input class=\"sbkSbia_HeaderInput sbk_Focusable\" name=\"admin_childpage_description\" id=\"admin_childpage_description\" type=\"text\" value=\"" + System.Net.WebUtility.HtmlEncode(staticWebContent.Description) + "\" /></td>");
            ...
            //Output.WriteLine("        <td><input class=\"sbkSbia_HeaderInput sbk_Focusable\" name=\"admin_childpage_keywords\" id=\"admin_childpage_keywords\" type=\"text\" value=\"" + System.Net.WebUtility.HtmlEncode(staticWebContent.Keywords) + "\" /></td>");
