...
{
    /// <summary> Item-level submission package module creates all the image derivative files from original jpeg and tiff files by utilizing Kakadu for the 
    /// JPEG2000 creation and ImageMagick for the JPEG creation </summary>
