...
namespace SobekCM.Engine_Library.Settings
{
    ...
    public static class InstanceWide_Settings_Builder
    {
        ...
        private const string CURRENT_WEB_VERSION = "5.1.0";

        /// <summary> Current version number associated with this SobekCM builder application </summary>
        private const string CURRENT_BUILDER_VERSION = "5.1.0";
        ...
        public static bool Refresh(InstanceWide_Settings SettingsObject, DataSet SobekCM_Settings)
        {
            ...
            try
            {
                ...
                Get_Integer_Value(settingsDictionary, "GCS Page Load URL Expiration Minutes", SettingsObject.Servers, X => X.GCS_Page_Load_Signed_Url_Expiration_Minutes, ref error, 10);
                Get_Integer_Value(settingsDictionary, "GCS Download URL Expiration Minutes", SettingsObject.Servers, X => X.GCS_Download_Signed_Url_Expiration_Minutes, ref error, 60);
                Get_Integer_Value(settingsDictionary, "GCS Restricted Streaming URL Expiration Minutes", SettingsObject.Servers, X => X.GCS_Restricted_Streaming_Signed_Url_Expiration_Minutes, ref error, 60);
