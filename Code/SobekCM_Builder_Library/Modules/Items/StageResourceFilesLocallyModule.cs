...
namespace SobekCM.Builder_Library.Modules.Items
{
    ...
    /// into the local resource folder before reprocessing, in GCS Hybrid mode </summary>
    ...
    /// local disk, none of them can operate against a GCS object directly. <br /><br />
    ...
    public class StageResourceFilesLocallyModule : abstractSubmissionPackageModule
    {
        ...
        /// before reprocessing, in GCS Hybrid mode </summary>
