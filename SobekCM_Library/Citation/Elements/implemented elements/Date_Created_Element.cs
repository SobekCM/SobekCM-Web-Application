...
namespace SobekCM.Library.Citation.Elements
{
    ...
    public class Date_Created_Element : SimpleTextBox_Element
    {
        /// <summary> Constructor for a new instance of the Date_Created_Element class </summary>
        public Date_Created_Element() : base("Creation Date", "create_date")
        {
            Repeatable = false;
        }
