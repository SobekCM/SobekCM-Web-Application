...
{
    /// <summary> Element allows entry of the creation date for an item </summary>
    /// <remarks> This class extends the <see cref="SimpleTextBox_Element"/> class. </remarks>
    public class Date_Captured_Element : SimpleTextBox_Element
    {
        /// <summary> Constructor for a new instance of the Date_Captured_Element class </summary>
        public Date_Captured_Element() : base("Captured Date", "capture_date")
        {
            Repeatable = false;
        }
        ...
        public override void Save_To_Bib(SobekCM_Item Bib)
        {
            ...
            foreach (string thisKey in getKeys)
            {
                ...
                {
                    Bib.Bib_Info.Origin_Info.Date_Created = HttpContext.Current.Request.Form[thisKey];
                    return;
                }
            }
        }
