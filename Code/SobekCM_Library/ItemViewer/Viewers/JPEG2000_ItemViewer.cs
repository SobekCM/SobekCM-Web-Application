...
namespace SobekCM.Library.ItemViewer.Viewers
{
    ...
    public class JPEG2000_ItemViewer_Prototyper : iItemViewerPrototyper
    {
        ...
        public virtual void Add_Menu_Items(BriefItemInfo CurrentItem, RequestCache RequestSpecificValues, List<Item_MenuItem> MenuItems)
        {
            ...
            var menuItem = new Item_MenuItem(Localization_Gateway.Item_Menu.Page_Images(CurrentRequest.Language), Localization_Gateway.Item_Menu.Zoomable(CurrentRequest.Language), null, url, ViewerCode);
