/**
Ver510_DB_Complete_PostgreSQL.sql  - OpenSobek

PostgreSQL equivalent of Ver510_DB_Complete.sql -- Ver501_DB_Complete_PostgreSQL.sql (the
5.0.1 PostgreSQL baseline) with Upgrade_to_Ver510_PostgreSQL.sql's changes folded in
(AdditionalWork_MetadataOnly item flag, per-extension settings storage and its two new
functions, GCS Hybrid file-system-mode settings, SaveStructMapModule builder module,
Can Submit Edit Online / Disabled Online Changes Link settings, AUDIO viewer type,
System Base Code rename, version stamp). Builds a complete Version 5.1.0 database from
scratch. Creates the `sobek_builder`/`sobek_user` roles, all tables, views, and
...
CREATE TABLE SobekCM_Item(
	...
	AdditionalWork_MetadataOnly boolean NOT NULL,
...
CREATE TABLE SobekCM_Settings(
	...
	Extension_Code varchar(50) NULL,
...
ALTER TABLE SobekCM_Item ALTER COLUMN AdditionalWork_MetadataOnly SET DEFAULT 'false';
...
-- This is used by the builder to determine what needs post-processing. Also returns the
-- metadata-only flag alongside the existing item info, so the Builder can tell a
-- metadata-only pass apart from a full reprocessing pass.
...
-- the builder that it should be post-processed. Also takes a second flag to set
...
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (8, 3, 'OCR Tiff files with a generic OCR command prompt', NULL, 'SobekCM.Builder_Library.Modules.Items.OcrTiffsModule', true, 80, NULL, NULL, NULL);
...
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (45, 3, 'Save the brief item metadata cache file', NULL, 'SobekCM.Builder_Library.Modules.Items.SaveProtobufCacheFile', true, 265, NULL, NULL, NULL);
...
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (46, 3, 'Use Tesseract to OCR TIFF files for textual material', NULL, 'SobekCM.Builder_Library.Modules.Items.TesseractOcrModule', true, 90, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (47, 3, 'Tell the engine to clear its in-memory cache for this item', NULL, 'SobekCM.Builder_Library.Modules.Items.ClearEngineCacheModule', true, 320, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (48, 3, 'Stage existing GCS-hosted files locally before reprocessing, in GCS Hybrid mode', NULL, 'SobekCM.Builder_Library.Modules.Items.StageResourceFilesLocallyModule', true, 5, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (49, 3, 'Upload master/derivative image files to GCS and remove the local scratch copy, in GCS Hybrid mode', NULL, 'SobekCM.Builder_Library.Modules.Items.PushMasterFilesToGcsModule', true, 315, NULL, NULL, NULL);
insert into SobekCM_Builder_Module (ModuleID, ModuleSetID, ModuleDesc, Assembly, Class, Enabled, "Order", Argument1, Argument2, Argument3) values (50, 3, 'Restore the structure map and main thumbnail from the active METS, for metadata-only updates', NULL, 'SobekCM.Builder_Library.Modules.Items.SaveStructMapModule', true, 155, NULL, NULL, NULL);
...
insert into SobekCM_Item_Viewer_Types (ItemViewTypeID, ViewType, "Order", DefaultView, MenuOrder) values (34, 'AUDIO', 8, true, 108);
...
insert into SobekCM_Settings (Setting_Key, Setting_Value, TabPage, Heading, Hidden, Reserved, Help, Options, SettingID, Dimensions) values ('Builder Last Message', '', 'Builder', 'Status', false, 3, 'Help for Builder Last Message', NULL, 56, NULL);
insert into SobekCM_Settings (Setting_Key, Setting_Value, TabPage, Heading, Hidden, Reserved, Help, Options, SettingID, Dimensions) values ('Builder Last Run Finished', '', 'Builder', 'Status', false, 3, 'Help for Builder Last Run Finished', NULL, 57, NULL);
...
insert into SobekCM_Settings (Setting_Key, Setting_Value, TabPage, Heading, Hidden, Reserved, Help, Options, SettingID, Dimensions) values ('Builder Operation Flag', 'STANDARD OPERATION', 'Builder', 'Status', false, 2, 'Last flag set when the builder/bulk loader ran.', 'STANDARD OPERATION|PAUSE REQUESTED', 5, NULL);
...
insert into SobekCM_Settings (Setting_Key, Setting_Value, TabPage, Heading, Hidden, Reserved, Help, Options, SettingID, Dimensions) values ('Builder Version', '', 'Builder', 'Status', false, 3, 'Help for Builder Version', NULL, 60, NULL);
...
insert into SobekCM_Settings (Setting_Key, Setting_Value, TabPage, Heading, Hidden, Reserved, Help, Options, SettingID, Dimensions) values ('Can Submit Edit Online', 'true', 'System / Server Settings', 'Disable Behavior', false, 2, 'Flag dictates if users can submit items online, or if this is disabled in this system.', 'true|false', 8, NULL);
insert into SobekCM_Settings (Setting_Key, Setting_Value, TabPage, Heading, Hidden, Reserved, Help, Options, SettingID, Dimensions) values ('Can Submit Items Online', 'true', 'System / Server Settings', 'Disable Behavior', false, 2, 'Flag dictates if users can submit items online, or if this is disabled in this system.', 'true|false', 61, NULL);
...
insert into SobekCM_Settings (Setting_Key, Setting_Value, TabPage, Heading, Hidden, Reserved, Help, Options, SettingID, Dimensions) values ('Disabled Online Changes Link', '', 'System / Server Settings', 'Disable Behavior', false, 2, 'When set, a user who reaches a mySobek viewer that would let them submit a new item or edit an existing one -- while online submissions/edits are disabled -- is redirected here instead of just being shown a disabled message. Leave blank to fall back to the site''s main home page.', NULL, 91, NULL);
...
insert into SobekCM_Settings (Setting_Key, Setting_Value, TabPage, Heading, Hidden, Reserved, Help, Options, SettingID, Dimensions) values ('GCS Bucket Name', '', 'System / Server Settings', 'Server Settings', false, 2, 'Name of the Google Cloud Storage bucket used when File System Mode is "GCS Hybrid".', NULL, 88, NULL);
insert into SobekCM_Settings (Setting_Key, Setting_Value, TabPage, Heading, Hidden, Reserved, Help, Options, SettingID, Dimensions) values ('GCS Restricted URL Expiration Minutes', '15', 'System / Server Settings', 'Server Settings', false, 2, 'How long (in minutes) a signed URL stays valid for a file on an IP- or user-group-restricted (but not dark) item. Deliberately much shorter than GCS Signed URL Expiration Minutes, since a signed URL is a bearer token that works for anyone holding it once handed out. Only used when File System Mode is "GCS Hybrid" or "GCS Full".', NULL, 89, NULL);
insert into SobekCM_Settings (Setting_Key, Setting_Value, TabPage, Heading, Hidden, Reserved, Help, Options, SettingID, Dimensions) values ('GCS Signed URL Expiration Minutes', '240', 'System / Server Settings', 'Server Settings', false, 2, 'How long (in minutes) a signed URL to a GCS-hosted file stays valid before expiring. Only used when File System Mode is "GCS Hybrid".', NULL, 90, NULL);
...
insert into SobekCM_Settings (Setting_Key, Setting_Value, TabPage, Heading, Hidden, Reserved, Help, Options, SettingID, Dimensions) values ('JPEG2000 Server Type', 'Built-In IIPImage', 'System / Server Settings', 'Server Settings', false, 2, 'Type of the JPEG2000 server found at the URL above.', 'Built-In IIPImage|None|GCS Scratch', 27, NULL);
...
insert into SobekCM_Settings (Setting_Key, Setting_Value, TabPage, Heading, Hidden, Reserved, Help, Options, SettingID, Dimensions) values ('System Base Code', 'SOBEK', 'General Settings', 'Instance Settings', false, 3, 'Base abbreviation for this instance which is immutable once the site is running.\n\nExamples: UFDC, dLOC, SOBEK, etc..', NULL, 43, '100');
...
insert into SobekCM_Settings (Setting_Key, Setting_Value, TabPage, Heading, Hidden, Reserved, Help) values ( 'Metadata Invalidation', '1/1/2020', 'Digital Resource Settings', 'Metadata Settings', false, 3, 'Date which all cached item metadata must be written since, or it will be regenerated.  See seperate page under Metadata Configuration to change this manually.' );
insert into SobekCM_Settings (Setting_Key, Setting_Value, TabPage, Heading, Hidden, Reserved, Help, Options) values ( 'Forward to Https', 'false', 'System / Server Settings', 'Server Settings', false, 2, 'Flag indicates whether requests to the application (excluding static file requests, such as images, css, and js) arriving over HTTP should be redirected to the HTTPS version of the same URL.', 'true|false' );
