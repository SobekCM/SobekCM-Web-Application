...
{
    /// <summary> Element allows simple entry of the creator(s) name for an item, while excluding any
    /// named entities that have roles.  This is used if there is a contributor field on the same
    /// entry form. </summary>
    /// <remarks> This class extends the <see cref="SimpleTextBox_Element"/> class. </remarks>
    public class Creator_MainOnly_Element : SimpleTextBox_Element
    {
        /// <summary> Constructor for a new instance of the Creator_MainOnly_Element class </summary>
        public Creator_MainOnly_Element()
