...
namespace SobekCM.Library.ItemViewer.Viewers
{
    ...
    public class Text_ItemViewer_Prototyper : iItemViewerPrototyper
    {
        ...
        public virtual void Add_Menu_Items(BriefItemInfo CurrentItem, RequestCache RequestSpecificValues, List<Item_MenuItem> MenuItems)
        {
            ...
            var menuItem = new Item_MenuItem(Localization_Gateway.Item_Menu.Page_Images(CurrentRequest.Language), Localization_Gateway.Text_Viewer.Menu_Text(CurrentRequest.Language), null, url, ViewerCode);
