...
{
    /// <summary> Embedded web content viewer prototyper, which is used to check to see if there is an embedded web URL, 
    /// to create the link in the main menu, and to create the viewer itself if the user selects that option </summary>
    public class Embedded_Web_Content_ItemViewer_Prototyper : iItemViewerPrototyper
    {
        /// <summary> Constructor for a new instance of the EmbeddedVideo_ItemViewer_Prototyper class </summary>
        public Embedded_Web_Content_ItemViewer_Prototyper()
        {
            ViewerType = "EMBEDDED_WEB_CONTENT";
            ViewerCode = "eweb";
        }
        ...
        {
            return !String.IsNullOrEmpty(CurrentItem.Behaviors.Embedded_Web_Content);
        }
        ...
        {
            return new Embedded_Web_Content_ItemViewer(CurrentItem, CurrentUser, CurrentRequest);
        }
    }


    /// <summary> Item viewer displays an embedded web content for a digital resource embedded into the SobekCM window for viewing. </summary>
    /// <remarks> This class extends the abstract class <see cref="abstractNoPaginationItemViewer"/> and implements the 
    /// <see cref="iItemViewer" /> interface. </remarks>
    public class Embedded_Web_Content_ItemViewer : abstractNoPaginationItemViewer
    {
        ...
        /// <param name="CurrentUser"> Current user, who may or may not be logged on </param>
        /// <param name="CurrentRequest"> Information about the current request </param>
        public Embedded_Web_Content_ItemViewer(BriefItemInfo BriefItem, User_Object CurrentUser, Navigation_Object CurrentRequest)
        {
        ...
        public override void Write_Main_Viewer_Section(TextWriter Output, Custom_Tracer Tracer)
        {
            if (Tracer != null)
            {
                Tracer.Add_Trace("Embedded_Web_Content_ItemViewer.Write_Main_Viewer_Section", "");
            }
