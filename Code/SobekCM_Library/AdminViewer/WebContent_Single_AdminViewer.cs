...
namespace SobekCM.Library.AdminViewer
{
    ...
    public class WebContent_Single_AdminViewer : abstract_AdminViewer
    {
        ...
        public override void Write_HTML(TextWriter Output, Custom_Tracer Tracer)
        {
            ...
            try
            {
                ...
                if (page < 10)
                {
                    ...
                    Output.WriteLine("    <button title=\"Do not apply changes\" class=\"sbkAdm_RoundButton\" onclick=\"return new_webcontent_edit_page('z');\"><img src=\"" + Static_Resources_Gateway.Button_Previous_Arrow_Png + "\" class=\"sbkAdm_RoundButton_LeftImg\" alt=\"\" /> " + Localization_Gateway.Buttons.Cancel(RequestSpecificValues.Current_Mode.Language) + "</button> &nbsp; &nbsp; ");
                    Output.WriteLine("    <button title=\"Save changes to this web content page or redirect\" class=\"sbkAdm_RoundButton\" onclick=\"return save_webcontent_edits(false);\"> " + Localization_Gateway.Buttons.Save(RequestSpecificValues.Current_Mode.Language) + " </button> &nbsp; &nbsp; ");
                    Output.WriteLine("    <button title=\"Save changes to this web content page or redirect and exit the admin screens\" class=\"sbkAdm_RoundButton\" onclick=\"return save_webcontent_edits(true);\">" + Localization_Gateway.Buttons.Save_And_Exit(RequestSpecificValues.Current_Mode.Language) + " <img src=\"" + Static_Resources_Gateway.Button_Next_Arrow_Png + "\" class=\"sbkAdm_RoundButton_RightImg\" alt=\"\" /></button>");
        ...
        private void Add_Page_General(TextWriter Output)
        {
            ...
            Output.WriteLine("    <td>");
            Output.WriteLine("      <table class=\"sbkSaav_InnerTable2\"><tr style=\"vertical-align:top\"><td><textarea class=\"sbkWcav_jumbo_textbox sbkAdmin_Focusable\" rows=\"6\" name=\"admin_webcontent_head\" id=\"admin_webcontent_head\">" + System.Net.WebUtility.HtmlEncode(webContent.Extra_Head_Info) + "</textarea></td>");
            Output.WriteLine("        <td><img class=\"sbkSaav_HelpButton\" src=\"" + Static_Resources_Gateway.Help_Button_Jpg + "\" onclick=\"alert('" + EXTRA_HEADER_HELP + "');\"  title=\"" + EXTRA_HEADER_HELP + "\" /></td></tr></table>");
            Output.WriteLine("     </td>");
            Output.WriteLine("  </tr>");
            ...
            Output.WriteLine("    <td>");
            Output.WriteLine("      <table class=\"sbkSaav_InnerTable\"><tr><td><input class=\"sbkWcav_large_input sbkAdmin_Focusable\" name=\"admin_webcontent_redirect\" id=\"admin_webcontent_redirect\" type=\"text\" value=\"" + System.Net.WebUtility.HtmlEncode(webContent.Redirect) + "\" /></td>");
            ...
            Output.WriteLine("    <td>");
            Output.WriteLine("      <table class=\"sbkSaav_InnerTable\"><tr><td><input class=\"sbkWcav_large_input sbkAdmin_Focusable\" name=\"admin_webcontent_banner\" id=\"admin_webcontent_banner\" type=\"text\" value=\"" + System.Net.WebUtility.HtmlEncode(webContent.Banner) + "\" /></td>");
            Output.WriteLine("        <td><img class=\"sbkSaav_HelpButton\" src=\"" + Static_Resources_Gateway.Help_Button_Jpg + "\" onclick=\"alert('" + BANNER_HELP + "');\"  title=\"" + BANNER_HELP + "\" /></td></tr></table>");
            Output.WriteLine("     </td>");
            Output.WriteLine("  </tr>");
        ...
        private void Add_Page_Child_Pages(TextWriter Output, Custom_Tracer Tracer)
        {
            ...
            if ((fixed_depth < 2) && (RequestSpecificValues.HasNonEmptyQueryString("l2")))
            {
                level2 = RequestSpecificValues.QueryString["l2"];
            }
            if ((fixed_depth < 3) && (!String.IsNullOrEmpty(level2)) && (RequestSpecificValues.HasNonEmptyQueryString("l3")))
            {
                level3 = RequestSpecificValues.QueryString["l3"];
            }
            if ((fixed_depth < 4) && (!String.IsNullOrEmpty(level3)) && (RequestSpecificValues.HasNonEmptyQueryString("l4")))
            {
                level4 = RequestSpecificValues.QueryString["l4"];
            }
            if ((fixed_depth < 5) && (!String.IsNullOrEmpty(level4)) && (RequestSpecificValues.HasNonEmptyQueryString("l5")))
            {
            ...
            //Output.WriteLine("          <td colspan=\"2\"><input class=\"sbkSaav_SubLargeInput sbkAdmin_Focusable\" name=\"admin_webcontent_label\" id=\"admin_webcontent_label\" type=\"text\" value=\"" + System.Net.WebUtility.HtmlEncode(childPageLabel ?? String.Empty) + "\" /></td>");
        ...
        {
            Tracer.Add_Trace("WebContent_Single_AdminViewer.add_upload_controls", String.Empty);
