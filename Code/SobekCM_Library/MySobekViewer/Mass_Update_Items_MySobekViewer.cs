...
namespace SobekCM.Library.MySobekViewer
{
    ...
    public class Mass_Update_Items_MySobekViewer : abstract_MySobekViewer
    {
        ...
        public Mass_Update_Items_MySobekViewer(RequestCache RequestSpecificValues, HttpContext Context) : base(RequestSpecificValues, Context)
        {
            ...
            string hidden_request = Context.Request.HasFormContentType ? (Context.Request.Form["behaviors_request"].TrimFirst() ?? String.Empty) : String.Empty;
        ...
        public override void Write_HTML(TextWriter Output, Custom_Tracer Tracer)
        {
            ...
            Output.WriteLine("      <li>Click <a href=\"" + UI_ApplicationCache_Gateway.Settings.System.Help_URL(RequestSpecificValues.Current_Mode.Base_URL) + "help/behaviors\" target=\"_EDIT_INSTRUCTIONS\">here for detailed instructions</a> on mass updating behaviors online.</li>");
            ...
            Output.WriteLine("        <button onclick=\"behaviors_cancel_form(); return false;\" class=\"sbkMySobek_BigButton\"><img src=\"" + Static_Resources_Gateway.Button_Previous_Arrow_Png + "\" class=\"sbkMySobek_RoundButton_LeftImg\" alt=\"\" /> " + Localization_Gateway.Buttons.Cancel(RequestSpecificValues.Current_Mode.Language) + " </button> &nbsp; &nbsp; ");
